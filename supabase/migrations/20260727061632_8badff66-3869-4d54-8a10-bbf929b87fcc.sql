-- Restore abd_items_search to row-per-record shape (matches defect_items_search / SM contract).
-- Only the final SELECT changes vs migration 20260726173246; status/delay-bucket mapping is preserved as-is.
-- Do not change this return shape without also updating src/hooks/useAbdItems.ts.
