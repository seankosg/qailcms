DROP FUNCTION IF EXISTS public.abd_dashboard_judgment_mix(text[]);
...
GRANT EXECUTE ON FUNCTION public.abd_dashboard_judgment_mix(text[], text[]) TO authenticated, service_role;