...
CREATE OR REPLACE FUNCTION public._snag_dim_val(_row public.defect_items_raw, _dim text)
RETURNS text LANGUAGE sql IMMUTABLE SET search_path TO 'public' AS $$
  SELECT COALESCE(NULLIF(TRIM(CASE _dim
...
LANGUAGE sql STABLE SET search_path TO 'public' AS $$
  WITH base AS (
    SELECT
      (ARRAY[
        public._snag_dim_val(r, _group_by[1]),
        public._snag_dim_val(r, _group_by[2]),
        public._snag_dim_val(r, _group_by[3]),
        public._snag_dim_val(r, _group_by[4]),
        public._snag_dim_val(r, _group_by[5]),
        public._snag_dim_val(r, _group_by[6]),
        public._snag_dim_val(r, _group_by[7]),
        public._snag_dim_val(r, _group_by[8]),
        public._snag_dim_val(r, _group_by[9])
...
LANGUAGE sql STABLE SET search_path TO 'public' AS $$
  ...
  events AS (
    ...
    CROSS JOIN LATERAL (VALUES
      ...
      ('rectified',     b.pcd, 1, 0,
        (b.acd IS NOT NULL AND b.acd <= _as_of_date)
