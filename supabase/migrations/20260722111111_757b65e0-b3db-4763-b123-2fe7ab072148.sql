-- Update start_status derivation and rectified_status backfill:
-- If status_raw is in the rectified/closed/verified family, start_status MUST be 'Done'
-- and rectified_status MUST be 'Rectified'.
...
-- Backfill: any stored row where status_raw indicates rectified/closed/verified
-- must have rectified_status = 'Rectified'.
