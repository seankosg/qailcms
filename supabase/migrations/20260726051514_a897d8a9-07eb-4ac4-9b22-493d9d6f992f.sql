-- Exclude terminated/cancelled from primary stats; expose excluded_count.
-- Also filter is_terminated in progress + facets/search RPCs.

DROP FUNCTION IF EXISTS public.abd_items_counts(text, boolean);
...
-- Progress RPCs: exclude terminated rows from base.
