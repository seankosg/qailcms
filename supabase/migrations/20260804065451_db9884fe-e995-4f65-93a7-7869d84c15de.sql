...
REVOKE ALL ON FUNCTION public.hdec_people_list(text, boolean) FROM public;
GRANT EXECUTE ON FUNCTION public.hdec_people_list(text, boolean) TO authenticated;