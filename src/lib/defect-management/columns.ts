...
export const DEFECT_COLUMNS: DefectColumnDef[] = [
  ...
  // Stage sets: [P.Date | A.Date | Status] × Start → Rectified → Pre-Ins → DAR-Ins → Closure → H/O
  ...
  { key: "planned_pre_inspection_date", label: "P.Pre-Ins", type: "date", width: 110, group: "progress", editable: true, editorType: "date" },
  { key: "actual_pre_inspection_date", label: "A.Pre-Ins", type: "date", width: 110, group: "progress", editable: true, editorType: "date" },
  { key: "planned_dar_inspection_date", label: "P.DAR-Ins", type: "date", width: 110, group: "progress", editable: true, editorType: "date" },
  { key: "actual_dar_inspection_date", label: "A.DAR-Ins", type: "date", width: 110, group: "progress", editable: true, editorType: "date" },
  ...
  { key: "planned_ho_date", label: "P.H/O", type: "date", width: 110, group: "progress", editable: true, editorType: "date" },
  { key: "actual_ho_date", label: "A.H/O", type: "date", width: 110, group: "progress", editable: true, editorType: "date" },
