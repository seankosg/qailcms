...
export const DEFECT_COLUMNS: DefectColumnDef[] = [
  ...
  { key: "podium_area", label: "Podium Area", type: "text", width: 120, group: "location" },
  { key: "building", label: "Building", type: "text", width: 110, group: "location" },
  { key: "room", label: "Room", type: "text", width: 110, group: "location" },
  { key: "room_group", label: "Room Group", type: "text", width: 120, group: "location" },
  { key: "level_name", label: "Level", type: "text", width: 90, group: "location" },
  ...
  { key: "trade_detail", label: "Trade Detail", type: "text", width: 140, group: "trade" },
  ...
  { key: "updated_status", label: "Updated Status", type: "badge", width: 120, group: "status" },
  ...
  { key: "classification_source", label: "Classification Source", type: "text", width: 150, group: "classification" },
