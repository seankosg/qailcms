...
export const SPARE_PART_COLUMNS: SparePartColumnDef[] = [
  ...
  { key: "issue_technical", label: "Issue (Technical)", type: "text", width: 160, group: "issue" },
  { key: "issue_supplier", label: "Issue (Supplier)", type: "text", width: 160, group: "issue" },
  { key: "issue_internal", label: "Issue (Internal)", type: "text", width: 160, group: "issue" },
