...
export const TM_COLUMNS: TmColumnDef[] = [
  ...
  { key: "tc_plan_pct", label: "TC.Plan", type: "percent", width: 100, group: "forecast", note: "기준일 하루치 계획 증분 = 누계계획(기준일) − 누계계획(전일)." },
  { key: "tc_actual_pct", label: "TC.Actual", type: "percent", width: 100, group: "forecast", note: "기준일 하루치 실적 증분 = 누계실적(기준일) − 누계실적(전일). 도하 날짜 경계 기준." },
