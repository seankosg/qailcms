...
export const TM_GANTT_ORIGINAL_ORDER: TmGanttOriginalCol[] = [
  ...
  { letter: "H", key: "pic",               label: "담당" },
  { letter: "I", key: "row_type",          label: "유형" },
  { letter: "J", key: "status_manual",     label: "상태" },
  { letter: "K", key: "plan_start",        label: "계획\n시작" },
  { letter: "L", key: "plan_end",          label: "계획\n완료" },
  { letter: "M", key: "plan_days",         label: "계획\n일수" },
  { letter: "N", key: "actual_start",      label: "실제\n시작" },
  { letter: "O", key: "actual_progress",   label: "실적\n진도율" },
  { letter: "P", key: "plan_progress",     label: "계획\n진도율" },
  { letter: "Q", key: "progress_variance", label: "진도차\n(%p)" },
  { letter: "R", key: "forecast_end",      label: "예상\n완료" },
  { letter: "S", key: "slip_days",         label: "차이\n(일)" },
  { letter: "T", key: "auto_judgment",     label: "자동\n판정" },
];
