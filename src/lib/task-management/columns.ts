...
export const TM_COLUMNS: TmColumnDef[] = [
  ...
  { key: "pic", label: "담당", type: "text", width: 120, group: "task", editable: true, editorType: "text" },
  { key: "row_type", label: "유형", type: "badge", width: 90, group: "task", editable: true, editorType: "select", options: [...ROW_TYPES] },
  { key: "status_manual", label: "상태", type: "badge", width: 90, group: "status", editable: true, editorType: "select", options: [...STATUS_MANUAL] },
  { key: "auto_judgment", label: "자동 판정", type: "badge", width: 120, group: "status" },
  { key: "plan_start", label: "계획 시작", type: "date", width: 110, group: "plan", editable: true, editorType: "date" },
  { key: "plan_end", label: "계획 완료", type: "date", width: 110, group: "plan", editable: true, editorType: "date" },
  { key: "plan_days", label: "계획 일수", type: "number", width: 90, group: "plan" },
  { key: "actual_start", label: "실제 시작", type: "date", width: 110, group: "actual", editable: true, editorType: "date" },
