 ...
 *
 * super_guest 는 2026-08-14 지시자 확정: 전 모듈 읽기 전용(Admin 탭 제외 — 역할 게이트로 차단).
 * guest 는 정본 미확정(계정 0명, BACKLOG #0804) → 대조 대상에서 제외.
 */
export type RclCanonRole = "super_guest" | "user" | "senior_user" | "d_superuser" | "superuser";
