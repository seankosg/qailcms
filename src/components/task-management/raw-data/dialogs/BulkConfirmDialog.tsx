...
import type { BulkEditableField } from "@/lib/task-management/columns";
            ...
            <tbody>
              {preview.map((r, i) => (
                <tr key={i} className="border-t">
                  <td className="px-2 py-1 font-mono">{fmt(r.task_no)}</td>
                  <td className="px-2 py-1">{fmt(field ? r[field.field] : "")}</td>
