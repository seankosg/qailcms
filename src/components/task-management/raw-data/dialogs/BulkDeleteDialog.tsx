...
import { applyBulkHardDelete } from "@/lib/task-management/bulk-actions";
...
export function BulkDeleteDialog({ open, onOpenChange, ids, onDone }: Props) {
    ...
    <Dialog open={open} onOpenChange={(v) => {
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            선택한 <strong>{ids.length}</strong>개 행을 <code>task_management_raw</code>에서
            영구 삭제합니다. 되돌릴 수 없습니다.
          </DialogDescription>
        </DialogHeader>
