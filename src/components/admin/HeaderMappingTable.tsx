...
import {
  ...
  SPARE_PART_HEADER_MAPPING_QK,
  type SparePartHeaderMappingRow,
} from "@/hooks/useSparePartHeaderMappings";
...
export function HeaderMappingTable() {
  ...
  const saveSourceHeader = async (r: SparePartHeaderMappingRow, trimmed: string) => {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          <CardTitle className="text-base">Header Mapping — Excel Import 별칭</CardTitle>
