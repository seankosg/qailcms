...
├──────────────┬─────────────────────────────────────────────────────────────┤
│ 이름 / 모듈   │ Aug'26  Sep   Oct   Nov   Dec   Jan'27  Feb   Mar          │
├──────────────┼─────────────────────────────────────────────────────────────┤
│ ▸ ARCH (12)   │  ← 팀 그룹 헤더                                            │
│ ▾ 김OO        │  ············································◆ 2026-11-20  │
│     TM        │   ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●  20-Oct-26                              │
...
- **행 구조**: 사람 = 요약 행 1개 + 그 아래 **모듈당 1행**(TM · SM · ABD · SPL · WRT 고정 순서).
  - 사람 요약 행: 이름 + 최종 철수일 마름모(◆) + `dd-MMM-yyyy` 라벨. 클릭 시 모듈 행 접기/펼치기.
  - 모듈 행: 좌측 라벨에 모듈 약칭, 본문에 해당 모듈의 시작~종결 막대(모듈 고유색) +
    끝점(●) + 종결일 라벨. 데이터 없는 모듈은 "—(해당 없음)" 으로 비활성 표시(행은 유지).
  - 상단 모듈 토글에서 끈 모듈은 행에서 숨기고 철수일 계산에서도 제외.
